...
internal open class KtUltraLightFieldImpl protected constructor(
    ...
    override val qualifiedNameForNullabilityAnnotation: String?
        get() {
            // In case of a non-backing field:
            // - object and companion object instance fields are @NotNull;
            // - enum entry fields don't have nullability annotations.
            if (declaration is KtObjectDeclaration) return NotNull::class.java.name
            val typeForAnnotation = kotlinType?.takeUnless { declaration is KtEnumEntry }
